...
class Masa(models.Model):
    ...
    supPrecio = models.DecimalField(decimal_places=2, default=0, min_value=0)
...
class Pizza(models.Model):
    nombre = models.CharField(max_length=50)
    precio = models.DecimalField(decimal_places=2, default=0, min_value=0)
...
class Ingrediente(models.Model):
    ...
    kcal = models.DecimalField(decimal_places=2, default=0, min_value=0)
